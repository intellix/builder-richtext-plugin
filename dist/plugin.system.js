...
const CodeBlockButton = () => {
    ...
    return (external_react_["default"].createElement(Button, { "data-test-id": "code-block-button", active: true, onPointerDown: (event) => {
            event.preventDefault();
        }, onClick: handleClick },
...
const RichText = (props) => {
    ...
    return (external_react_["default"].createElement(Slate, { editor: editor, initialValue: props.initialValue?.length > 0
        ...
        external_react_["default"].createElement(Toolbar, null,
            ...
            external_react_["default"].createElement(BlockButton, { format: "blockquote", icon: "format_quote" }),
